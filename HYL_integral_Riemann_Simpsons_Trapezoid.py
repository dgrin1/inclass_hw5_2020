...
# test
print(RiemannSum(function,2,0,100))
print("Difference from the theoretical value is: ",abs(RiemannSum(lambda x : x**4-2*x+1,0,2,100)-4.4))
print("\n")


# test
print(TrapezoidSum(function,2,0,100))
print("Difference from the theoretical value is: ",abs(TrapezoidSum(lambda x : x**4-2*x+1,0,2,100)-4.4))
print("\n")


# test
print(SimpsonsSum(function,2,0,100))
print("Difference from the theoretical value is: ",abs(SimpsonsSum(lambda x : x**4-2*x+1,0,2,100)-4.4))
print("\n")
